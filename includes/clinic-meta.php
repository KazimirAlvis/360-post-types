...
function render_clinic_addresses_box( $post ) {
  ...
  <style>
    ...
    .clinic-address-row .addr-row input.addr-zip { max-width:90px; flex:none; }
    .clinic-address-row .addr-row input.addr-coord { max-width:160px; flex:none; }
    .clinic-address-row .addr-label { font-weight:600; margin-bottom:6px; }
    .clinic-address-row .remove-address { float:right; }
  </style>
  ...
  jQuery(function($){
    ...
    $('#add-address').on('click', function(e){
      ...
      container.append( makeRow(index) );
    });
