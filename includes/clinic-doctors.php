    ...
    if ($clinic_doctors) {
        ...
        foreach ($clinic_doctors as $doc) {
            ...
            if ( $photo_id ) {
                ...
                $base_path   = plugin_dir_path( __FILE__ ) . '../assets/images/doctor-images/';
                $base_url    = trailingslashit( dirname( untrailingslashit( $plugin_dir ) ) ) . 'assets/images/doctor-images/';
